    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <div class="">
            <h6 class="m-0 font-weight-bold text-primary">Winner's List</h6>
          </div>
        </div>
        <div class="card-body">
              ...
              <tbody>
                <tr >
                  ...
                  <td class="text-center">
                    <button href="" class="btn btn-sm btn-primary btn-circle mr-2" data-toggle="modal" data-target="#exampleModal"><i data-toggle="tooltip" data-placement="top" title="More Information" class="fas fa-info-circle"></i></button>
                    <a href="" class="btn btn-sm btn-primary btn-circle mr-2" data-toggle="tooltip" data-placement="top" title="Edit"><i class="far fa-edit"></i></a>
